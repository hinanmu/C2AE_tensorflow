...
class Parser(object):
    ...
    def __init__(self):
        ...
        parser.add_argument("--project", default="mirflickr/", help="Project Folder")
        parser.add_argument("--folder_suffix", default="mirflickr", help="Folder Name Suffix")
        parser.add_argument("--dataset", default="mirflickr", help="Name of the Dataset")
        parser.add_argument("--opt", default="rmsprop", help="Optimizer : adam, rmsprop, sgd, momentum.")
